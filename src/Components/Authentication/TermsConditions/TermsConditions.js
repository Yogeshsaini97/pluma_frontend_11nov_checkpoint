        ...
        <div>
          ...
          >
            <div
              ...
              style={{ height: "67.6rem", width: "84.2rem" }}
            >
              <div
                className="CircleCross"
                style={{ marginRight: "75rem", marginTop: "-2.5rem" }}
              >
                <Link to="/CreateAccount">
                  <div
                    className="InsideCircleCross"
                    style={{
                  ...
                  >
                    <img src="/assets/SvgNav/VectorX.svg" alt="error" />
                  </div>
                </Link>
              </div>
              ...
              <div className="headingContainer" style={{ marginTop: "-4%" }}>
